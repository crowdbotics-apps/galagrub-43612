"""
Django settings for galagrub_43612 project.
...
ROOT_URLCONF = 'galagrub_43612.urls'
...
WSGI_APPLICATION = 'galagrub_43612.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "galagrub_43612 API",
    "DESCRIPTION": "API documentation for galagrub_43612 App",
    "VERSION": "v1",
}
